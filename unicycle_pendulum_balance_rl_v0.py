...
def train(env, sb3_algo):
    ...
    eval_env = RewardWrapper(gym.make('UnicyclePendulumBalance-v0', render_mode=None, max_episode_steps=MAX_EPISODE_STEPS))
...
if __name__ == '__main__':
    ...
    gymenv = RewardWrapper(gym.make('UnicyclePendulumBalance-v0', render_mode=None, max_episode_steps=MAX_EPISODE_STEPS))
    ...
    if args.test:
        if os.path.isfile(args.test):
            ...
            test_env = RewardWrapper(gym.make('UnicyclePendulumBalance-v0', render_mode='human', max_episode_steps=MAX_EPISODE_STEPS))
